<div class="navbar navbar-inverse set-radius-zero" >
 ...
 <li>
                           ...
                           <li>
                                ...
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="add-users.php">Add New User</a></li>
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="manage-users.php">Manage Users</a></li>
                                </ul>
                            </li>
                                                       <li>
                                <a href="#" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown"> Admins <i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                            
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="manage-admins.php">Manage Admins</a></li>
                                </ul>
                            </li>
