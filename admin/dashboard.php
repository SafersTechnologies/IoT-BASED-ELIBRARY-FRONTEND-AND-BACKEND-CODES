...
$update = "UPDATE ipaddress SET ip='$UpdateIp'";
...
$result5 = mysqli_query($db,$update);
...
<?php 
$query4 = "select ip from ipaddress";
$ip = mysqli_query($db,$query4);
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
				...
				<input name="ip" type="text" value="<?php echo $savedIp; ?>">
				<input type="submit" name="UpdateIp" value="Update Ip">
				</form>
				</h4>
...
<?php 
$query2 = "select id from tblstudents";
